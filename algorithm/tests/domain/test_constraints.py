...
def test_max_height_constraint_finds_placements() -> None:
...
def test_max_height_constraint_finds_no_placements() -> None:
    items_and_placements = [
...
def test_max_height_constraint_returns_empty_list_if_given_empty_list() -> None:
...
def test_max_item_weight_constraint_finds_placements() -> None:
    storage_system_shape = StorageSystemShape("test_system", 1, 1, 1)
    storage_system = StorageSystem(
        shape=storage_system_shape,
        max_weight=5,
...
def test_max_item_weight_constraint_finds_no_placements() -> None:
    storage_system_shape = StorageSystemShape("test_system", 1, 1, 1)
    storage_system = StorageSystem(
        shape=storage_system_shape,
        max_weight=1,
...
def test_max_item_weight_constraint_raises_domain_error_if_weights_missing() -> None:
    storage_system_shape = StorageSystemShape("test_system", 1, 1, 1)
    storage_system = StorageSystem(
        shape=storage_system_shape,
    )
